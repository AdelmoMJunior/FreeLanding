export const landingContent = {
  ...
  leadForm: {
    ...
    description: "Envie seus dados para receber um retorno objetivo sobre sua necessidade.",
    submitLabel: "Enviar contato",
    successTitle: "Mensagem enviada",
    successMessage: "Recebemos seus dados. Em breve alguém entra em contato pelo canal informado.",
    successDismissLabel: "OK",
    requiredLabel: "obrigatório",
    nameLabel: "Nome",
    emailLabel: "E-mail",
    phoneLabel: "WhatsApp ou telefone",
    phoneHelper: "Opcional, mas ajuda no retorno rápido.",
    companyLabel: "Empresa",
    messageLabel: "Mensagem",
    messageHelper: "Opcional. Use se quiser adiantar o principal ponto da conversa.",
    messagePlaceholder: "Ex.: quero entender valores, prazos ou como a solução se aplica ao meu caso.",
  },
} as const;
